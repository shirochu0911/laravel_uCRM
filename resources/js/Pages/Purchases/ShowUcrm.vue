                                ...
                                <div class="container px-5 py-8 mx-auto">
                                    <div class="mx-auto lg:w-1/2 md:w-2/3">
                                        <div class="flex flex-wrap -m-2">
                                            <div class="w-full p-2">
                                                <div class="relative">
                                                    ...
                                                    <div type="date" id="date" name="date"
                                                        ...
                                                        {{ dayjs(props.order[0].create_at).format('YYYY/MM/DD') }}</div>
                                                </div>
                                            </div>
                                            <div class="w-full p-2">
                                                <div class="relative">
                                            ...
                                            <div class="w-full p-2">
                                                <div class="">
                                                    <label for="price" class="text-sm leading-7 text-gray-600">ステータス</label>
                                            ...
                                            <div class="w-full p-2">
                                                <div class="">
                                                    <label for="price"
                                                        class="text-sm leading-7 text-gray-600">キャンセル日</label>
                                                    <div v-if="props.order[0].status == false"
                                                        class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200">
